...
credit_data<-read_delim('./german_data/german.data', delim = " ",
                        col_name = FALSE)


col_name<-c("status","duration","credit_history", "purpose", "credit_amount", 
            "savings_account","employment","installment_rate","personal_status",
            "guarantors","residence_since","property","age","installment_plans",
            "housing", "num_credit", "job","dependent","telephone","foreign_worker",
            "assessment")

colnames(credit_data)<- col_name
